  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <button
        ...
        className="glass flex flex-col items-center justify-center gap-2 py-16 transition-colors"
        style={{ borderStyle: "dashed", borderColor: dragging ? "var(--accent)" : "var(--glass-border)" }}
      >
